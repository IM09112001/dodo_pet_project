...
export const PIZZAS_COMBO:Array<ComboProducts>=[
	{
		...
		products:[['Индейка и грибы',47000],
			['Гавайская',47000],
...
export const PIZZAS: Array<Product> = [
	{
		...
		title: 'Чикен Бомбони',
		price: 59000,
		description:'Сладкий перец, куриные кусочки, сыр моцарелла, красный лук, соус чили, смесь сыров чеддер и пармезан',
	...
	},
	{
		...
		price: 75000,
		description:'Сыр моцарелла, пепперони, смесь сыров чеддер и пармезан, пицца-соус',
		img: 'https://cdn.dodostatic.net/static/Img/Products/5eca54ca8e3f4c4b986a26cdb7d7d09a_584x584.jpeg',
		sizes: {
			small: {
				price: 23,
	...
	},
	{
		...
		addons: ['Сыр моцарелла','Чеддер и пармезан','Томаты','Шампиньоны','Острый халапеньо','Брынза','Соленые огурчики','Сыр блю чиз','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+4,
		title: 'Чизбургер-пицца',
		price: 49000,
		description:'Митболы из 100% говядины, сыр моцарелла из цельного молока, красный лук, соленые огурчики, томаты, сырный соус',
		...
		addons: ['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Ветчина','Пикантная пепперони','Шампиньоны','Острый халапеньо','Соленые огурчики','Сыр блю чиз','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+5,
		title: 'Додо',
		price: 65000,
		description:'Индейка, говядина, пепперони с говядиной, моцарелла из цельного молока, шампиньоны, сладкий перец, красный лук, томатный соус, томаты',
		...
		addons:['Сыр моцарелла','Чеддер и пармезан','Говядина','Ветчина','Острый халапеньо','Брынза','Соленые огурчики','Сыр блю чиз','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+6,
		title: 'Четыре сезона',
		price: 55000,
		description:'Моцарелла из цельного молока, индейка, пепперони с говядиной, брынза, томаты, шампиньоны, томатный соус, итальянские травы',
	...
	},
	{
		...
		addons: ['Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Шампиньоны','Острый халапеньо','Соленые огурчики','Сыр блю чиз',],
	},
	{
		id: PIZZAS_COMBO.length+8,
		title: 'Двойная пепперони',
		price: 65000,
		description:'Пепперони с говядиной, увеличенная порция моцареллы из цельного молока, томатный соус',
		...
		addons:['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Говядина','Ветчина','Томаты','Шампиньоны','Острый халапеньо','Брынза','Соленые огурчики','Сыр блю чиз','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+9,
		title: 'Чиззи чеддер',
		price: 55000,
		description:'Ветчина из цыпленка, сладкий перец, моцарелла из цельного молока, томатный соус, итальянские травы, чеснок, сыр чеддер',
		...
		addons: ['Цыпленок','Говядина','Пикантная пепперони','Томаты','Шампиньоны','Острый халапеньо','Брынза','Соленые огурчики','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+10,
		title: 'Маргарита \uD83C\uDF31',
		price: 39000,
		description:'Увеличенная порция моцареллы из цельного молока, томаты, итальянские травы, томатный соус',
		...
		addons:['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Шампиньоны','Ананасы','Острый халапеньо','Брынза','Соленые огурчики','Сыр блю чиз',],
	},
	{
	...
	},
	{
		...
		price: 49000,
		description:'Индейка, шампиньоны, увеличенная порция моцареллы из цельного молока, томатный соус',
		...
		addons:['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Говядина','Пикантная пепперони','Красный лук','Томаты','Шампиньоны','Острый халапеньо','Соленые огурчики','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+13,
		title: 'Гавайская',
		price: 49000,
		description:'Ветчина из цыпленка, ананасы, моцарелла из цельного молока, томатный соус',
		...
		addons: ['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Красный лук','Томаты','Шампиньоны','Острый халапеньо','Брынза','Сыр блю чиз',],
	},
	{
		id: PIZZAS_COMBO.length+14,
		title: 'Овощи и грибы \uD83C\uDF31 ',
		price: 55000,
		description:'Моцарелла из цельного молока, брынза, шампиньоны, сладкий перец, томаты, томатный соус, базилик, красный лук',
		...
		addons:['Сыр моцарелла','Цыпленок','Говядина','Ветчина','Пикантная пепперони','Ананасы','Острый халапеньо','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+15,
		title: 'Мексиканская \uD83C\uDF36️\uD83C\uDF36️ ',
		price: 55000,
		description:'Цыплёнок, моцарелла из цельного молока, томатный соус, перец халапеньо, сладкий перец, соус сальса, томаты, красный лук',
		...
		addons:['Сыр моцарелла','Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Острый халапеньо','Сыр блю чиз','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+16,
		title: 'Мясная',
		price: 59000,
		description:'Митболы из говядины, индейка, пепперони с говядиной, моцарелла из цельного молока, томатный соус',
		...
		addons:['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Ветчина','Пикантная пепперони','Томаты','Шампиньоны','Брынза','Острый халапеньо','Сыр блю чиз','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+17,
		title: 'Цыпленок барбекю',
		price: 59000,
		description:'Цыпленок, моцарелла из цельного молока, ветчина из цыпленка, соус барбекю, томатный соус, красный лук',
		...
		addons:['Сыр моцарелла','Чеддер и пармезан','Говядина','Пикантная пепперони','Томаты','Брынза','Острый халапеньо','Соленые огурчики','Сыр блю чиз',],
	},
	{
		id: PIZZAS_COMBO.length+18,
		title: 'Цыпленок ранч',
		price: 59000,
		description:'Цыпленок, моцарелла из цельного молока, ветчина из цыпленка, соус ранч, томаты',
		...
		addons:['Сыр моцарелла','Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Шампиньоны','Ананасы','Острый халапеньо','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+19,
		title: 'Крэйзи пепперони',
		price: 59000,
		description:'Цыпленок, пепперони с говядиной, моцарелла из цельного молока, кисло-сладкий соус, томатный соус',
		...
		addons: ['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Томаты','Шампиньоны','Ананасы','Брынза','Острый халапеньо','Соленые огурчики','Сыр блю чиз'],
	},
	{
		id: PIZZAS_COMBO.length+20,
		title: 'Супермясная',
		price: 65000,
		description:'Цыпленок, пепперони с говядиной, моцарелла из цельного молока, индейка, охотничьи колбаски, томатный соус',
		...
		addons: ['Сыр моцарелла','Чеддер и пармезан','Говядина','Ветчина','Сладкий перец','Томаты','Шампиньоны','Брынза','Острый халапеньо','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+21,
		title: 'Пепперони фреш',
		price: 45000,
		description:'Пепперони с говядиной, увеличенная порция моцареллы из цельного молока, томаты, томатный соус',
		...
		addons: ['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Говядина','Ветчина','Пикантная пепперони','Сладкий перец','Шампиньоны','Ананасы','Острый халапеньо','Соленые огурчики','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+22,
		title: '4 сыра',
		price: 65000,
		description:'Моцарелла из цельного молока, сыр блю чиз, сыр пармезан, сыр чеддер, томатный соус',
		...
		addons: ['Цыпленок','Говядина','Ветчина','Пикантная пепперони','Томаты','Шампиньоны','Острый халапеньо','Соленые огурчики','Итальянские травы'],
	},
	{
		id: PIZZAS_COMBO.length+23,
		title: 'Пицца "Вулкан" \uD83C\uDF36️\uD83C\uDF36️ ',
		price: 65000,
		description:'Пепперони с говядиной, моцарелла из цельного молока, говядина, перец халапеньо, соус барбекю, сладкий перец, томаты, красный лук',
		...
		addons: ['Сыр моцарелла','Цыпленок','Чеддер и пармезан','Ветчина','Шампиньоны','Ананасы','Брынза','Соленые огурчики','Сыр блю чиз','Итальянские травы'],
	},
	{
		...
		addons: ['Цыпленок','Говядина','Ветчина','Пикантная пепперони','Томаты','Шампиньоны','Острый халапеньо','Соленые огурчики',],
	},
	{
